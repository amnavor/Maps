...
def enumerate(s, start=0):
    ...
    [[5, 'f'], [6, 'i'], [7, 'v'], [8, 'e']]
    """
    return zip(range(start,start+len(s)),s) #range start, start+len(s) prints the numbers
    #ie 5, 6, 7; s is just the values. you print both together in a list via zip
